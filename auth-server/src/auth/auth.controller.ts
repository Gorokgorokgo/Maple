...
export class AuthController {
  ...
  @Post('register')
  @ApiOperation({ summary: '회원가입', description: 'ID : 영문 + 숫자, 4자 이상 20자까지<br/>' +
    'PASSWORD : 소문자, 대문자, 숫자, 특수문자를 모두 포함하여 8자 이상 15자리' })
  ...
  @Post('login')
  @ApiOperation({ summary: '로그인', description: 'ID + PW 조합으로 JWT를 발급합니다.' })
